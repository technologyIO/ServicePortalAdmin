...
function ReportedProblem() {
  ...
  const downloadReportedProblemExcel = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_URL}/excel/reportedproblems/export-reportedproblems`,
        {
          method: "GET",
        }
      );
      ...
      if (response.ok) {
        ...
        alert("Failed to download Reported Problem Excel file");
      }
    } catch (error) {
  ...
  // Add this function inside your ReportedProblem component
      ...
      {loader ? (
        ...
        <>
          <div className="bg-gray-100 border border-gray-200 rounded-lg p-4 shadow-sm">
            {/* Top Row: Search Bar & Main Actions */}
            ...
            {/* Second Row: Upload, Filter, Download Excel */}
