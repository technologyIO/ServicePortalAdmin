...
function ProductBulk() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Agar koi record failed hua to toast ke through error message dikhayein
  ...
  // Product sample CSV content (only product related fields)
  const csvContent = `productgroup,partnoid,product,subgrp,frequency,dateoflaunch,endofsaledate,endofsupportdate,exsupportavlb,installationcheckliststatusboolean,pmcheckliststatusboolean
Electronics,PN-001,Smartphone,Mobile,High,2022-01-15,2023-01-15,2024-01-15,true,true,false
Electronics,PN-002,Laptop,Computers,Medium,2021-05-10,2022-05-10,2023-05-10,true,false,true
Electronics,PN-003,Tablet,Mobile,Low,2022-03-20,2023-03-20,2024-03-20,false,true,true
Appliances,PN-004,Refrigerator,Kitchen,Medium,2020-09-05,2021-09-05,2022-09-05,true,true,true
Appliances,PN-005,Microwave,Kitchen,Low,2021-11-11,2022-11-11,2023-11-11,false,false,false
Furniture,PN-006,Office Chair,Office,Low,2022-06-25,2023-06-25,2024-06-25,true,true,true`;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">
                Upload multiple product records at once
              </p>
            </div>
            <button
                ...
                <div className="border border-gray-200 rounded-lg divide-y divide-gray-200">
                  {(result?.results || []).map((item, index) => (
                    <div key={index} className="p-3 flex items-center justify-between">
                      <div>
                        <p className="font-medium text-gray-800">{item.partnoid}</p>
                        {item.message && (
                          <p className="text-sm text-gray-500">{item.message}</p>
                        )}
                      </div>
                      <div className="flex items-center gap-2">
                        {(item.status === "Created" || item.status === "Replaced") ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                            height="20"
