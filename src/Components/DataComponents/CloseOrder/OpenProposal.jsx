                ...
                <tr key={proposal._id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-3 text-center">
                    <button
                      onClick={() =>
                        window.open(
                          `${process.env.REACT_APP_BASE_URL}/phone/proposal/${proposal.proposalNumber}/cnote-pdf`,
                          "_blank"
                        )
                      }
                  ...
                  <td className="p-3 text-center">
                    <button
                      onClick={() =>
                        window.open(
                          `${process.env.REACT_APP_BASE_URL}/phone/proposal/${proposal.proposalNumber}/quote-pdf`,
                          "_blank"
                        )
                      }
