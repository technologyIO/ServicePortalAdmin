    ...
    <div className="md:col-span-2">
      ...
      {reports
        ...
        .map((report) => {
          ...
          return (
            <div key={report._id} className="bg-gray-50 p-3 rounded-md mb-2">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-sm font-semibold text-blue-800">Permissions for: {reportName}</h3>
              ...
              <div className="flex flex-wrap gap-4">
                {["read", "write", "edit", "delete"].map((permission) => (
                  <div key={permission} className="flex items-center">
                    ...
                    />
                    <label htmlFor={`report-${permission}-${report._id}`} className="ml-1 text-sm text-gray-700">
