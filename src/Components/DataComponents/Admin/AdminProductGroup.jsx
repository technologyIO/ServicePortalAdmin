...
const AdminProductGroup = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/collections/searchproductgroupy?q=${searchQuery}`
      );
  ...
  const getAllData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/collections/productgroup?page=${page}&limit=${limit}`
      )
      .then((res) => {
        setLoader(false);
