...
function ProblemName() {
  ...
  const [problemname, setCheckListType] = useState({});
  ...
  const handleToggleStatus = async (id, currentStatus, checkListTypeName) => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_BASE_URL}/complaints/problemname/${id}`,
        {
  ...
  const getAllCountries = (pageNum = page) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/complaints/pageproblemname?page=${pageNum}&limit=${limit}`
      )
      .then((res) => {
        setLoader(false);
              ...
              <ModalDialog size="lg" className="p-2 ">
                ...
                >
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          defaultValue={problemname?.status || ""}
                          onChange={(e, value) =>
                  ...
                  <div className="flex items-center justify-end mt-3 rounded-b">
                    ...
                    <button
                      onClick={() => handleSubmit(problemname?._id)}
                      type="submit"
