...
function CheckPointType() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/collections/searchCheckPointType?q=${searchQuery}`
      );
  ...
  const getAllCountries = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/collections/CheckPointType?page=${page}&limit=${limit}`
      )
      .then((res) => {
        setLoader(false);
