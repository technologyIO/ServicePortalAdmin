...
function CheckListType() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/collections/searchCheckListType?q=${searchQuery}`
      );
  ...
  const getAllCountries = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/collections/CheckListType?page=${page}&limit=${limit}`
      )
      .then((res) => {
        setLoader(false);
  ...
  const handleAddCountry = () => {
    axios
      .post(
        `${process.env.REACT_APP_BASE_URL}/collections/CheckListType`,
        CheckListType
      )
      .then((res) => {
        getAllCountries();
                      ...
                      <th scope="col" className="p-4">
                        <div className="flex items-center">
                          <input
                            ...
                            type="checkbox"
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded"
                            checked={selectedRows?.includes(checkListType?._id)}
                            onChange={() => handleRowSelect(checkListType?._id)}
                          />
                          <label
              ...
              <ModalDialog size="lg" className="p-2 ">
                ...
                >
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          defaultValue={CheckListType?.status || ""}
                          onChange={(e, value) =>
                  ...
                  <div className="flex items-center justify-end mt-3 rounded-b">
                    ...
                    <button
                      onClick={() => handleSubmit(CheckListType?._id)}
                      type="submit"
