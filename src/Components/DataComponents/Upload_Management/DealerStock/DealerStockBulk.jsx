...
function DealerStockBulk() {
  ...
  // DealerStock sample CSV content
  const csvContent = `dealercodeid,dealername,dealercity,materialcode,materialdescription,plant,unrestrictedquantity,status
D-001,Dealer One,New York,MC-101,Material Description 1,Plant-A,100,Active
D-002,Dealer Two,Los Angeles,MC-102,Material Description 2,Plant-B,200,Active
D-003,Dealer Three,Chicago,MC-103,Material Description 3,Plant-C,150,Inactive`;
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.setAttribute("download", "dealerstock_sample.csv");
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-xl font-bold text-gray-800">
                Dealer Stock Bulk Upload
              </h2>
              <p className="text-gray-500 text-sm mt-1">
                This will delete all existing Dealer Stock records and upload new data from the file.
              </p>
            </div>
            <button
