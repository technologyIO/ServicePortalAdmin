...
function PreventiveMaintenance() {
  ...
  const getData = () => {
    ...
    axios
      ...
      .then((res) => {
        setLoader(false);
        setData(res.data.pms); // Corrected key to 'pms'
                  ...
                  <div class="grid md:grid-cols-2 md:gap-6 w-full">
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <input
                        type="text"
                        placeholder="MM/YYYY"
                        maxLength={7} // Format is MM/YYYY, so max 7 characters
                        onChange={(e) => {
                        ...
                        onBlur={(e) => {
                          const value = e.target.value;
                          const regex = /^(0[1-9]|1[0-2])\/\d{4}$/; // Valid format MM/YYYY
                    ...
                    <div className="relative w-full mb-5 group">
                      ...
                      <input
                        ...
                        maxLength={10} // Format is DD/MM/YYYY, so max 10 characters
                        onChange={(e) => {
                          const value = e.target.value;
                          if (value.length <= 10) {
                        ...
                        onBlur={(e) => {
                          const value = e.target.value;
                          const regex = /^\d{2}\/\d{2}\/\d{4}$/; // Valid format DD/MM/YYYY
                          if (!regex.test(value) && value) {
