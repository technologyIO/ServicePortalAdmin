...
function AmcContractBulk() {
  ...
  // AMC Contract sample CSV content (with fields as per schema)
  const csvContent = `salesdoc,startdate,enddate,satypeZDRC_ZDRN,serialnumber,materialcode,status
DOC-001,2023-01-01,2023-12-31,ZDRC,SN-001,MC-001,Active
DOC-002,2023-02-01,2023-11-30,ZDRN,SN-002,MC-002,Inactive
DOC-003,2023-03-01,2023-10-31,ZDRC,SN-003,MC-003,Active`;
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.setAttribute("download", "amccontract_sample.csv");
